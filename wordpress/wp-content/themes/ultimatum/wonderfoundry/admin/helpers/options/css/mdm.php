...
$options= array(
    ...
    array(
        'name' => __('Mobile menu Button Background Color'),
        'id' => 'cssvar137',
        'type' => "color",
        'property' => 'background-color',
    ),
    array(
        'name' => __('Mobile menu Button Text Color'),
        'id' => 'cssvar136',
        'type' => "color",
        'property' => 'color',
    ),
    array(
        'name' => __('Mobile menu Item text Color'),
        'id' => 'cssvar138',
        'type' => "color",
        'property' => 'color',
    ),
    array(
        'name' => __('Mobile menu Item text color :hover'),
        'id' => 'cssvar139',
        'type' => "color",
        'property' => 'color',
    ),
    array(
        'name' => __('Mobile menu Item Background color'),
        'id' => 'cssvar139',
        'type' => "color",
        'property' => 'background-color',
    ),
